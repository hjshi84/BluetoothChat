...
public class MotionRender implements Renderer{
    float cameraRotateX,cameraRotateY;
    float box[] = new float[] {
            // FRONT
            -0.5f, -0.5f,  0.5f,
            0.5f, -0.5f,  0.5f,
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        //gl.glRotatef(cameraRotateX, 1, 0, 0);  //绕着(0,0,0)与(1,0,0)即x轴旋转
        //gl.glRotatef(cameraRotateY, 0, 1, 0);
        gl.glRotatef(BluetoothChat.myIMU.get(0).IMUY, 1, 0, 0);
        gl.glRotatef(BluetoothChat.myIMU.get(0).IMUX, 0, 1, 0);
        //六个面一个面绘制一种颜色
